...
public class UIElementWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UIElement), typeof(System.Object));
		L.RegFunction("New", _CreateUIElement);
	...
	static int _CreateUIElement(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UIElement.New");
			}
		}
		catch (Exception e)
		{
